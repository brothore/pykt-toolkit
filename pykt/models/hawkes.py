...
class HawkesKT(nn.Module):
    ...
    def __init__(self, n_skills, n_problems, emb_size, time_log, emb_type="qid", ablation_type="none"):
        ...
        self.ablation_type = ablation_type  # New argument for ablation
        ...
        # Initialize embeddings only if not ablated
        if self.ablation_type != "alpha":
