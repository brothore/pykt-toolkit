...
from pykt.preprocess import data_proprocess, process_raw_data_multi_datasets
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d","--dataset_name", type=str, default="assist2015",nargs="+")
    ...
    # process raw data
    if "peiyou" in args.dataset_name:
        dname2paths["peiyou"] = args.file_path
        print(f"fpath: {args.file_path}")
    dname, writef = process_raw_data_multi_datasets(args.dataset_name, dname2paths)
    print("-"*50)
